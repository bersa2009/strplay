...
class _MusicSearchScreenState extends State<MusicSearchScreen> {
  ...
  // WebView controller (video oynatma için)
    ...
    try {
      ...
      if (_cameras!.isNotEmpty) {
        _cameraController = CameraController(
          ...
          enableAudio: false, // Ses kaydını kapat, müzik çalsın
        );
  ...
  Future<void> _searchMusic(String query) async {
    ...
    try {
      ...
      for (var video in searchResults.take(20)) {
        // SkipVids köprüsü için iframe URL'sini al
  ...
  /// SkipVids'ten iframe URL'sini scrape et
  Future<String?> _getSkipVidsIframeUrl(String videoId) async {
    try {
      ...
      print('SkipVids scraping hatası: $e');
    }
    
    // Fallback: Direkt YouTube embed URL'si
  ...
  Future<void> _playAudio(Map<String, dynamic> song) async {
    try {
      ...
      if (audioStream != null) {
        ...
        // Audio Service ile arka plan oynatma
        ...
        child: Container(
          ...
          child: WebView(
            ...
            navigationDelegate: (request) {
              // SkipVids dışındaki linklere gitmeyi engelle
...
class MyAudioHandler extends BaseAudioHandler {
  ...
  Future<void> setRepeatMode(AudioServiceRepeatMode repeatMode) async {
    // Implement repeat mode if needed
  }

  @override
  Future<void> setShuffleMode(bool enabled) async {
    // Implement shuffle mode if needed
  }
